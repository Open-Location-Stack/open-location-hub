...
- Collision support is intentionally bounded and configuration-gated; it does not yet model cross-hub correlation, richer polygon semantics, or broader OMLOX collision behaviors beyond trackable-versus-trackable detection, and its WGS84 distance model remains an approximation chosen for runtime cost rather than navigation-grade precision.
