...
- when architecture or behavior changes, ensure `docs/architecture.md` is updated to reflect the implemented state, and track remaining architectural follow-up in GitHub issues
